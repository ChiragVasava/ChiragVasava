...
const chirag = {
  ...
  focus     : ["MERN Stack", "Next.js", "DSA with Java", "UI/UX"],
  currentProject : "Password Manager (React + Tailwind + MongoDB + Express)",
  funFact   : "I debug with console.log and I'm not ashamed 😅",
  availableFor   : ["Freelance", "Collaboration", "Open Source"],
};
```
...
<table>
  ...
  <tr>
    <td>🌱 Learning</td>
    <td>Advanced Tailwind · Next.js · MongoDB · Express.js · DSA with Java</td>
  </tr>
  <tr>
    <td>👯 Open to Collaborate</td>
    <td><a href="https://github.com/ChiragVasava/PlayLoud.git">🎵 PlayLoud</a></td>
  </tr>
  <tr>
    <td>💬 Ask Me About</td>
    <td>React · JavaScript · Tailwind · Responsive Design · UI/UX</td>
  </tr>
  <tr>
    <td>📫 Reach Me At</td>
